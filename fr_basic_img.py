...
imgElonTest = face_recognition.load_image_file('fr_images/elon_musk_2.jpg')
...
cv2.putText(imgElonTest,
            f'{results} {round(faceDis[0], 2)}', (50, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)
